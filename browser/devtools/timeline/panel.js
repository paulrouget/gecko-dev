...
TimelinePanel.prototype = {
  ...
  open: function() {
    ...
    return targetPromise
      .then(() => {
        ...
        return this.panelWin.startupTimeline();
      })
      .then(() => {
        this.isReady = true;
        this.emit("ready");
      ...
      .then(null, function onError(aReason) {
        DevToolsUtils.reportException("TimelinePanel.prototype.open", aReason);
      });
  },
  ...
  destroy: function() {
    ...
    return this._destroyer = this.panelWin.shutdownTimeline().then(() => {
      this.emit("destroyed");
    });
  }
};
