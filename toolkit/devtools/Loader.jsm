  ...
  load: function() {
    this.loader = new loader.Loader({
      ...
      paths: {
        ...
        "devtools/app-validator": "resource://gre/modules/devtools/app-validator",
...
SrcdirProvider.prototype = {
  ...
  load: function() {
    ...
    let appValidatorURI = this.fileURI(OS.Path.join(toolkitDir, "app-validator"));
    ...
    this.loader = new loader.Loader({
      ...
      paths: {
        ...
        "devtools/app-validator": appValidatorURI,
